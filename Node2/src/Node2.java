...
public class Node2 {
	...
	public static ArrayList<String> LayDanhSachFile(String dir)
	{
        ...
        if(listOfFiles.length>0)
        {
        	...
        	System.out.println("==NODE 2 saving file: ");
	...
	public static void MoKetNoiToiClient() throws Exception
	{
		    ...
		    {    	
				...
				System.out.println("============The node 2 is listening for connections from the client...");
	...
	public static void Connect()
	{
		try {
			...
			Node node=new Node(0, serverPort, "Node2,"+ip, ds);
			//System.out.println("Node1,"+ip);
			gson=new Gson();
			
	    	nodeSocket = new Socket(InetAddress.getByName(severname), 1742);
	    	
	    	node.setTen(node.getTen()+","+serverPort);
	    	chuoiNode=gson.toJson(node);
