...
public class Node1 {
	...
	public static ArrayList<String> LayDanhSachFile(String dir)
	{
        ...
        if(listOfFiles.length>0)
        {
        	...
        	System.out.println("==NODE 1 saving file: ");
	...
	public static void MoKetNoiToiClient() throws Exception
	{
		    ...
		    {    	
				...
				System.out.println("============The node 1 is listening for connections from the client...");
	...
	public static void Connect()
	{
		try {
			...
			Node node1=new Node(0, serverPort, "Node1,"+ip, ds);
